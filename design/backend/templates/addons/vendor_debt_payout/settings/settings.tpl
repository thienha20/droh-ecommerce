...
<div id="collapsable_addon_option_vendor_debt_payout_catalog_items" class="in collapse">
    <fieldset>
        ...
        <div class="control-group setting-wide">
            ...
            <div class="controls">
                <p>{__("vendor_debt_payout.edit_description", ["[link]" => fn_url("products.update?product_id={$payout_product_id}")])}</p>
            </div>
        </div>
        ...
        <div class="control-group setting-wide">
            ...
            <div class="controls">
                <p>{__("vendor_debt_payout.edit_description", ["[link]" => fn_url("categories.update?category_id={$payout_category_id}")])}</p>
            </div>
        </div>
    </fieldset>
</div>
