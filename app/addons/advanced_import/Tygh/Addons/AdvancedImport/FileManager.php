...
class FileManager
{
     ...
     * @return bool
     */
    public function checkAllowedExtension($ext)
    {
        foreach ($this->allowed_ext as $allowed_extension) {
