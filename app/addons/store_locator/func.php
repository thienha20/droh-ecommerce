 ...
 *
 * Actions performed:
 *     - Adds data about the selected store when placing an order using API
 *
 * @param array $params       Request parameters
 ...
 */
function fn_store_locator_api_orders_create_after_get_user_data(array $params, $status, array $data, $valid_params, array $auth, array &$cart)
{
    // phpcs:ignore
    if (isset($params['select_store'])) {
        $cart['select_store'] = $params['select_store'];
    }
}
