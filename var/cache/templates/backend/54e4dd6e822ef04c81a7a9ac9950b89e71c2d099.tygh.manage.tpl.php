<?php /* Smarty version Smarty-3.1.21, created on 2024-03-27 10:13:12
         compiled from "C:\wamp64\www\cscart\design\backend\templates\views\orders\manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13160498846603c708b20121-98241212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54e4dd6e822ef04c81a7a9ac9950b89e71c2d099' => 
    array (
      0 => 'C:\\wamp64\\www\\cscart\\design\\backend\\templates\\views\\orders\\manage.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '13160498846603c708b20121-98241212',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6603c708d38dd0_18574750',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6603c708d38dd0_18574750')) {function content_6603c708d38dd0_18574750($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/wamp64/www/cscart/app/functions/smarty_plugins\\block.hook.php';
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("orders_table", null, null); ob_start(); ?>
        <div class="table-responsive-wrapper longtap-selection">
            ...
            <tr>
                ...
                <th width="15%">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"order_id",'text'=>$_smarty_tpl->__("id")), 0);?>
                ...
                <th width="17%">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"customer"), 0);?>
...
$_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:manage_header"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
                ...
                <th width="10%" class="right">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/table_col_head.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('type'=>"total"), 0);?>
...
">@</a> <?php }?>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php } elseif ($_smarty_tpl->tpl_vars['o']->value['user_id']) {?>
                        <a href="<?php echo htmlspecialchars(fn_url("profiles.update?user_id=".((string)$_smarty_tpl->tpl_vars['o']->value['user_id'])), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['o']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
</a>
                    <?php }?>
