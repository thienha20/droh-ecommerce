<?php /* Smarty version Smarty-3.1.21, created on 2024-03-27 11:02:56
         compiled from "C:\wamp64\www\cscart\design\backend\templates\views\orders\details.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16034397156603d2b0266aa7-76977368%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b2bc8e4a0af1ee3a31568b54e1ee565629b87661' => 
    array (
      0 => 'C:\\wamp64\\www\\cscart\\design\\backend\\templates\\views\\orders\\details.tpl',
      1 => 1652778226,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '16034397156603d2b0266aa7-76977368',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6603d2b07bc115_74948912',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6603d2b07bc115_74948912')) {function content_6603d2b07bc115_74948912($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/wamp64/www/cscart/app/functions/smarty_plugins\\block.hook.php';
    ...
    <div class="row-fluid">
        <div class="span8">
            ...
            <div class="table-responsive-wrapper">
                ...
                <thead>
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"orders:items_list_head")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"orders:items_list_head"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:items_list_head"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['oi']->value['original_price']), 0);
                    ...
                    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"orders:product_quantity")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"orders:product_quantity"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
&nbsp;<?php echo $_smarty_tpl->__("shipped");?>
                    ...
                    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"orders:product_quantity"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
" />
                            ...
                            <?php } else { ?>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="tracking_number" class="input-full" type="text" name="update_shipping[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping']->value['group_key'], ENT_QUOTES, 'UTF-8');?>
...
" />
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $_smarty_tpl->getSubTemplate ("common/carriers.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"carrier_key",'meta'=>"input-full",'name'=>"update_shipping[".((string)$_smarty_tpl->tpl_vars['shipping']->value['group_key'])."][".((string)$_smarty_tpl->tpl_vars['shipment_id']->value)."][carrier]",'carrier'=>$_smarty_tpl->tpl_vars['carrier']->value), 0);?>
                            ...
                            <div class="clearfix">
                                <?php if ($_smarty_tpl->tpl_vars['shipping']->value['need_shipment']) {?>
                                    ...
                                    <?php if (fn_check_view_permissions("shipments.add")) {?>
                                        ...
                                        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('id'=>"add_shipment_".((string)$_smarty_tpl->tpl_vars['shipping']->value['group_key']),'content'=>'','link_text'=>((string)$_smarty_tpl->tpl_vars['shipment_btn']->value).((string)$_smarty_tpl->tpl_vars['link_text_icon']->value),'act'=>"link",'href'=>" ",'link_class'=>"pull-".((string)$_smarty_tpl->tpl_vars['align']->value)), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
    <?php $_smarty_tpl->tpl_vars['sidebar_meta'] = new Smarty_variable("sidebar--order-details", null, 0);?>
